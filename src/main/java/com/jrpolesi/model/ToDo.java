...
public class ToDo {
    ...
    public boolean equals(Object o) {
        ...
        ToDo toDo = (ToDo) o;
        return isCompleted() == toDo.isCompleted() && Objects.equals(getTitle(), toDo.getTitle()) && Objects.equals(getDescription(), toDo.getDescription());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getTitle(), getDescription(), isCompleted());
    }
}
